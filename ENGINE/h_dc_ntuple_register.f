      subroutine h_dc_Ntuple_register(ABORT,err)
*----------------------------------------------------------------------
*
...
*
      character*17 here
      parameter (here='h_dc_Ntuple_register')
*
      logical ABORT
      character*(*) err
*
...
*--------------------------------------------------------
      ...
      ABORT = .FALSE.
*
      call G_reg_C('HMS_dc_Ntuple',h_dc_Ntuple_file,ABORT,err)
*
      IF(ABORT) THEN
