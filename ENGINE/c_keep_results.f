...
!! TH: To make this consistent with what is used in c_physics.f eliminate
!! scer cut.
...
!!! TH - TEST effect of scer cut on the "pions" in SOS - comment out PASS
!        1.UPDATE configuration above and uncomment below:
